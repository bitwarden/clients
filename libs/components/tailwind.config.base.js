...
module.exports = {
  ...
  safelist: [
    // Text color utilities for Storybook dynamic class generation
    "tw-text-fg-white",
    "tw-text-fg-dark",
    "tw-text-fg-contrast",
    "tw-text-fg-heading",
    ...
    "tw-text-fg-disabled",
    "tw-text-fg-brand-soft",
    "tw-text-fg-brand",
    "tw-text-fg-brand-strong",
    "tw-text-fg-success",
    "tw-text-fg-success-strong",
    "tw-text-fg-danger",
    "tw-text-fg-danger-strong",
    "tw-text-fg-warning",
    "tw-text-fg-warning-strong",
    "tw-text-fg-sensitive",
    "tw-text-fg-accent-primary-soft",
    "tw-text-fg-accent-primary",
    "tw-text-fg-accent-primary-strong",
    "tw-text-fg-accent-secondary-soft",
    "tw-text-fg-accent-secondary",
    "tw-text-fg-accent-secondary-strong",
    "tw-text-fg-accent-tertiary-soft",
    "tw-text-fg-accent-tertiary",
    "tw-text-fg-accent-tertiary-strong",
    // Border color utilities for Storybook dynamic class generation
    "tw-border-border-muted",
    "tw-border-border-light",
    "tw-border-border-base",
    "tw-border-border-strong",
    "tw-border-border-buffer",
    "tw-border-border-brand-soft",
    "tw-border-border-brand",
    "tw-border-border-brand-strong",
    "tw-border-border-success-soft",
    "tw-border-border-success",
    "tw-border-border-success-strong",
    "tw-border-border-danger-soft",
    "tw-border-border-danger",
    "tw-border-border-danger-strong",
    "tw-border-border-warning-soft",
    "tw-border-border-warning",
    "tw-border-border-warning-strong",
    "tw-border-border-accent-primary-soft",
    "tw-border-border-accent-primary",
    "tw-border-border-accent-secondary-soft",
    "tw-border-border-accent-secondary",
    "tw-border-border-accent-tertiary-soft",
    "tw-border-border-accent-tertiary",
    "tw-border-border-focus",
  ],
