...
switch (platform) {
  ...
  case "win32":
    switch (arch) {
      case "x64":
        localFileExisted = existsSync(join(__dirname, "desktop_napi.win32-x64-msvc.node"));
        try {
          if (localFileExisted) {
        ...
        break;
      case "ia32":
        localFileExisted = existsSync(join(__dirname, "desktop_napi.win32-ia32-msvc.node"));
        try {
          if (localFileExisted) {
        ...
        break;
      case "arm64":
        localFileExisted = existsSync(join(__dirname, "desktop_napi.win32-arm64-msvc.node"));
        try {
          if (localFileExisted) {
  ...
  case "darwin":
    switch (arch) {
      case "x64":
        ...
        break;
      case "arm64":
        localFileExisted = existsSync(join(__dirname, "desktop_napi.darwin-arm64.node"));
        try {
          if (localFileExisted) {
  ...
  case "linux":
    switch (arch) {
      case "x64":
        localFileExisted = existsSync(join(__dirname, "desktop_napi.linux-x64-musl.node"));
        try {
          if (localFileExisted) {
        ...
        break;
      case "arm64":
        localFileExisted = existsSync(join(__dirname, "desktop_napi.linux-arm64-musl.node"));
        try {
          if (localFileExisted) {
