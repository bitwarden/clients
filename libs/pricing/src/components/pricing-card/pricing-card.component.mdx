...
| `activeBadge` | `{ text: string; show: boolean }`                                                                           | **Optional.** Active plan badge positioned on the same line as title, aligned to the right. Defaults to "Active plan" text with show: false    |
