...
**InputPasswordFlow.ChangeExistingPassword**
...
export interface PasswordInputResult {
  ...
  currentPassword?: string; // included if the flow is ChangeExistingPassword or ChangeExistingPasswordAndOptionallyRotateAccountEncryptionKey
  rotateAccountEncryptionKey?: boolean; // included if the flow is ChangeExistingPasswordAndOptionallyRotateAccountEncryptionKey
}
```
