  ...
  <div class="theme_dark tw-bg-bg-primary tw-p-6 tw-rounded-lg">
    ...
    <div class="sb-unstyled tw-mb-6">
      ...
      <div class="tw-grid tw-grid-cols-1 tw-gap-2">
        ...
        <BackgroundCard name="success-strong" primitiveColor="green-600" />
        ...
        <BackgroundCard name="danger-strong" primitiveColor="red-600" />
        ...
        <BackgroundCard name="warning-strong" primitiveColor="orange-500" />
      </div>
    </div>
