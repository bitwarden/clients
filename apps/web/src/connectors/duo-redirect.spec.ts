...
describe("duo-redirect", () => {
  describe("redirectToDuoFrameless", () => {
    ...
    it.skip("should throw an error for a URL using HTTP protocol", () => {
    ...
    it.skip("should throw an error for a URL with javascript code", () => {
    ...
    it.skip("should throw an error for a non-HTTPS URL", () => {
    ...
    it.skip("should throw an error for a URL with invalid port specified", () => {
    ...
    it.skip("should throw an error for a URL with an invalid pathname", () => {
    ...
    it.skip("should throw an error for a URL with an invalid hostname", () => {
    ...
    it.skip("should throw an error for a URL with credentials", () => {
