...
| <i class="bwi bwi-collection-shared"></i> | bwi-collection-shared | collection                                          |
...
| Icon                                   | bwi-name           | Usage                                        |
| -------------------------------------- | ------------------ | -------------------------------------------- |
| <i class="bwi bwi-archive"></i>        | bwi-archive        | -                                            |
...
| <i class="bwi bwi-import"></i>         | bwi-import         | import a file                                |
...
| <i class="bwi bwi-drag-and-drop"></i> | bwi-drag-and-drop | drag and drop handle                                    |
...
| Icon                                     | bwi-name             | Usage                                          |
| ---------------------------------------- | -------------------- | ---------------------------------------------- |
| <i class="bwi bwi-bell"></i>             | bwi-bell             | -                                              |
...
| <i class="bwi bwi-brush"></i>            | bwi-brush            | -                                              |
