...
describe("VaultItemDrawerComponent", () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [TestVaultItemDrawerComponent],
      providers: [
    ...
    fixture = TestBed.createComponent(TestVaultItemDrawerComponent);
  ...
  describe("archive button", () => {
    it("not show archive button in admin console", () => {
    ...
    it("show archive button when the user can archive the item and the item can be archived", () => {
      component.setTestCipher({ canBeArchived: true });
      (component as any).userCanArchive$ = of(true);
      component.setTestParams({ mode: "form" });
      fixture.detectChanges();
    ...
    it("not show archive button when the user cannot archive the item", () => {
    ...
    it("not show archive button when the item cannot be archived", () => {
  ...
  describe("unarchive button", () => {
    it("show the unarchive button when the item is archived", () => {
    ...
    it("not show the unarchive button when the item is not archived", () => {
  ...
  describe("archive badge", () => {
    it('show "archived" badge when the item is archived and not an admin console action', () => {
      component.setTestCipher({ isArchived: true });
      component.setTestParams({ mode: "view" });
      fixture.detectChanges();
    ...
    it('not show "archived" badge when the item is archived and is an admin console action', () => {
      component.setTestCipher({ isArchived: true });
  ...
  describe("submitButtonText$", () => {
    it("return 'unArchiveAndSave' when premium is false and cipher is archived", (done) => {
    ...
    it("return 'save' when cipher is archived and user has premium", (done) => {
    ...
    it("return 'save' when cipher is not archived", (done) => {
      jest.spyOn(component as any, "userHasPremium$", "get").mockReturnValue(of(false));
      component.setTestCipher({ isArchived: false });
      fixture.detectChanges();
