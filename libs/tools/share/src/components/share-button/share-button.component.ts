 ...
 *
 * When placed inside a dialog, activating it closes that dialog so the sharing surface is not
 * covered, and skips re-prompt — the dialog could not have been opened without passing it.
 */
@Component({
