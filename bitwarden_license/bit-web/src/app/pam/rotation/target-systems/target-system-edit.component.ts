...
export class TargetSystemEditComponent {
  ...
  /**
   * Only an active, automatic target can claim a connector assignment — mirrors the target-systems
   * tab's `canAssignConnectors` row flag and `TargetSystemsService.activeAutomaticSystems$`.
   */
  protected readonly canAssignConnectors = computed(() => this.isActive() && this.isAutomatic());
