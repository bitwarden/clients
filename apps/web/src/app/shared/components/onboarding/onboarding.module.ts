...
import { AccordionComponent, BadgeComponent, IconTileComponent } from "@bitwarden/components";
...
@NgModule({
  imports: [SharedModule, AccordionComponent, BadgeComponent, IconTileComponent],
