...
import { GroupRequest } from "@bitwarden/common/admin-console/services/organization/requests/group.request";
import { OrganizationGroupBulkRequest } from "@bitwarden/common/admin-console/services/organization/requests/organization-group-bulk.request";
import {
  GroupDetailsResponse,
  GroupResponse,
} from "@bitwarden/common/admin-console/services/organization/responses/group.response";
