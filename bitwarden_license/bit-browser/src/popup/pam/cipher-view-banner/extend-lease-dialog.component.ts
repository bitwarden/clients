...
import {
  type AccessLeaseExtensionRequest,
...
/**
 * Extend-an-active-lease dialog: a duration from {@link EXTENSION_DURATION_OPTIONS} and a required
 * reason. Resolves with the request to submit, or `undefined` when canceled.
 */
@Component({
  selector: "app-pam-extend-lease-dialog",
