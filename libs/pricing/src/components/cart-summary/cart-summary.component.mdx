...
export type Cart = {
  ...
  discounts?: CartDiscount[]; // Optional cart-level discounts, rendered in the discount section
...
renders indented under its line item, while the cart-level discount renders in the dedicated
discount section:
