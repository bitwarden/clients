...
export class VaultListComponent<C extends CipherViewLike> {
  ...
  protected readonly showBulkMove = input<boolean>();
  protected readonly showBulkTrashOptions = input<boolean>();
  ...
  protected readonly allGroups = input<GroupView[]>([]);
  protected readonly showBulkEditCollectionAccess = input<boolean>(false);
  protected readonly showBulkAddToCollections = input<boolean>(false);
  ...
  protected onAddCollection = output<void>();

  protected readonly canCreateCollections = input<boolean>(false);
