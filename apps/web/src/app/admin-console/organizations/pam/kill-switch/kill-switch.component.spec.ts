...
describe("KillSwitchComponent", () => {
  ...
  describe("feature-flag gating", () => {
    it("hides the kill-switch section when PamKillSwitch flag is false", async () => {
    ...
    it("shows the kill-switch section when PamKillSwitch flag is true", async () => {
  ...
  describe("success state", () => {
    it("shows the success callout after a successful bulk revoke", async () => {
      ...
      expect(pamApiService.bulkRevokeLeases).toHaveBeenCalledWith("org-1");
  ...
  describe("partial-failure state", () => {
    it("shows the partial callout after a partial bulk revoke", async () => {
      ...
      const result: BulkRevokeResult = {
        ...
        failedCount: 2,
        failures: [
          { leaseId: "l-1", reason: "expired" },
          { leaseId: "l-2", reason: "concurrent" },
        ],
      };
      pamApiService.bulkRevokeLeases.mockResolvedValue(result);
