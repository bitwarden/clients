...
- Use a small badge to indicate a new notification of a status change that is not related to a
  specific count.
- Use a large badge to indicate item count information for multiple new notifications.

Berries are automatically size based on whether a count is provided
...
- Counts of **1-9**: Display in a compact circular shape
- Counts of **10-999**: Display in a pill shape with padding
