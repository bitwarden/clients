...
effect. Use `[spotlightPadding]` to control the space around the highlighted area and
`[spotlightBorder]="true"` to add an accent border.

<Canvas of={stories.SpotlightTour} />

<Canvas of={stories.SpotlightWithBorder} />
