    ...
    this.environmentService.environment$
      ...
      .subscribe((env) => {
        if (this.loginUiState === LoginUiState.MASTER_PASSWORD_ENTRY) {
          ...
          // Fetch new prelogin data for the updated region. The cache is keyed on email alone,
          // so without clearing it the refetch is a cache hit and the previous region's KDF
          // config persists.
