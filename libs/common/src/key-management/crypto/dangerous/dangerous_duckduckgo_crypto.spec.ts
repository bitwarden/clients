import { Aes256CbcHmacKey } from "@bitwarden/common/platform/models/domain/symmetric-crypto-key";
...
const MAC = Utils.fromHexToArray("b1c89cc2ab5af50e4bbe1599e1c07489bd4525f89eb81712d479c4112a7bbf62");
...
describe("DANGEROUS_aesDecryptDuckDuckGoNoPaddingAes256CbcHmac", () => {
    it("decrypts a valid DuckDuckGo 2.iv|data|mac encstring", async () => {
        ...
        const decrypted = await DANGEROUS_aesDecryptDuckDuckGoNoPaddingAes256CbcHmac(
