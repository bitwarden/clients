...
export const ALERT_EXCLUSIONS_DISK = new StateDefinition("alertExclusions", "disk");
...
export const VAULT_BROWSER_HEALTH_INTRO = new StateDefinition("vaultBrowserHealthIntro", "disk");
