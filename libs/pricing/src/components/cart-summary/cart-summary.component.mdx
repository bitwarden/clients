...
export type CartItem = {
  ...
  discounts?: Discount[]; // Optional item-level discounts, rendered as rows beneath the line
...
export type Cart = {
  ...
  discounts?: Discount[]; // Optional cart-level discounts, rendered in the discount section
