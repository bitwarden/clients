...
| `titleLevel` | `"h1" \| "h2" \| "h3" \| "h4" \| "h5" \| "h6"`                                | **Optional.** Heading level for accessibility. Defaults to "h3" |
...
- **Icons**: Uses `bwi-check` icon with primary-600 styling from icon library
