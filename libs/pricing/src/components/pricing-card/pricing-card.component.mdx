...
| `noPaddingTop` | `boolean`                                                                                                        | **Optional.** Will not apply top padding styles when true. (Default: false)                                                                             |
| `noBorder`     | `boolean`                                                                                                        | **Optional.** Will not apply card border styles when true. (Default: false)                                                                             |
