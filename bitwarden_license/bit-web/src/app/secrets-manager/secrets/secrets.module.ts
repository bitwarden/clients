...
import { SecretGeneratorComponent } from "./dialog/secret-generator.component";
...
@NgModule({
  imports: [SecretsManagerSharedModule, SecretsRoutingModule, SecretGeneratorComponent],
  declarations: [
