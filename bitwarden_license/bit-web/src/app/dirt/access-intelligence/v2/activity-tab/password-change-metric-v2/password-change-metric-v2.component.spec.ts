...
/**
 * Mock type for AccessSecurityTasksService that uses BehaviorSubjects
...
describe("PasswordChangeMetricV2Component", () => {
  ...
  describe("Initialization", () => {
    ...
    it("should call loadTasks$ with the organizationId on init", () => {
      expect(mockAccessSecurityTasksService.loadTasks$).toHaveBeenCalledWith(orgId);
    });
  });
  ...
  describe("assignTasks", () => {
    ...
    it("calls requestPasswordChangeForCriticalApplications$ with unassigned cipher IDs", () => {
      mockAccessSecurityTasksService.requestPasswordChangeForCriticalApplications$.mockReturnValue(
        of(undefined),
      );
