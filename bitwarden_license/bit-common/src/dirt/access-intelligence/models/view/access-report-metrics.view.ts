...
/**
 * View model for Access Intelligence aggregate metrics.
 *
 * UI-facing projection of {@link AccessReportMetrics} with helpers for the
 * summary strip and dashboard widgets. Safe to serialize; no decryption
 * required.
 */
