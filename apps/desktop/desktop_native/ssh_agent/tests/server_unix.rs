...
use common::{
    ...
    read_framed_response, test_ecdsa_p256_key, test_ecdsa_p256_key_blob, test_ecdsa_p384_key,
    test_ecdsa_p384_key_blob, test_ecdsa_p521_key, test_ecdsa_p521_key_blob, test_ed25519_key,
