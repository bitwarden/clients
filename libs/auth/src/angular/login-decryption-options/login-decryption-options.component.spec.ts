...
describe("LoginDecryptionOptionsComponent", () => {
    ...
    describe("createUser with feature flag enabled", () => {
        ...
        beforeEach(async () => {
            ...
            const mockSignedPublicKey = "mock-signed-public-key";
            const mockSigningKey = new Uint8Array(64);
            const mockSecurityState: SignedSecurityState = {
            ...
            const mockDeviceKey = new Uint8Array(64);
            const mockUserKey = new Uint8Array(64);
