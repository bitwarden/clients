...
import { PasswordPreloginResult } from "@bitwarden/common/auth/password-prelogin";
...
export class PasswordLoginCredentials {
  ...
  constructor(
    ...
    /**
     * Prefetched prelogin data and the source it came from. If provided, skips the
     * prelogin call during login and derives the master key from the captured source.
     */
    public preFetchedPreloginResult?: PasswordPreloginResult,
  ) {}
}
