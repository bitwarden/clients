...
import { AnonLayoutWrapperDataService, IconModule, ToastService } from "@bitwarden/components";
...
@Component({
  ...
  imports: [SendAccessFileComponent, SendAccessTextComponent, SharedModule, IconModule],
