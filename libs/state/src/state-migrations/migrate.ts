...
import { ClearClipboardDelayToStringMigrator } from "./migrations/76-clear-clipboard-delay-to-string";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(ClearClipboardDelayToStringMigrator, 75, CURRENT_VERSION);
}
