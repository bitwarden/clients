...
export class RotationConfigEditComponent {
  ...
  private async initializeCreateMode(): Promise<void> {
    const [configsResponse] = await Promise.all([
      this.pamApi.listRotationConfigs(this.organizationId),
  ...
  private async loadConfig(): Promise<RotationConfigDetailsResponse | null> {
    try {
      return await this.pamApi.getRotationConfig(this.organizationId, this.configId!);
    } catch {
  ...
  protected readonly submitCreate = async (): Promise<void> => {
    ...
    try {
      await this.pamApi.createRotationConfig(this.organizationId, request);
      this.toastService.showToast({
        variant: "success",
  ...
  protected readonly submitSettings = async (): Promise<void> => {
    ...
    try {
      await this.pamApi.updateRotationConfigSettings(this.organizationId, this.configId!, request);
      this.toastService.showToast({
        variant: "success",
  ...
  protected readonly submitAccount = async (): Promise<void> => {
    ...
    try {
      await this.pamApi.updateRotationConfigAccount(this.organizationId, this.configId!, request);
      this.toastService.showToast({
        variant: "success",
